...
\textbf{\Large Ali Alkhatib} & \textbf{Contact Information} \\
...
\begin{itemize}
  \item
    ...
    {Ph.D. Computer Science (in progress)}{2014 - present}
  \item
    \ressubheading{University of California, Irvine}{Irvine, CA}
    {B.A. Anthropology, B.S. Informatics}{2012 - 2014}
    \begin{itemize}
      \resitem{Honors: Phi Beta Kappa}
      \resitem{Informatics specialization: Human-Computer Interaction}
      \resitem{Anthropology honors thesis: \textit{The Culture of Quantified Self}}
      \resitem{Advisor: Tom Boellstorff}
    \end{itemize}
...
\begin{itemize}
  \item
    \ressubheading{Microsoft Research}{Redmond, WA}{FUSE Labs}{June 2015 - September 2015}
    \begin{itemize}
      \resitem{Ethnographic study of laborers}
...
\begin{enumerate}
  ...
  \item
    ...
    {\it Quantified Self: Ethnography of a Digital Culture}.
...
\item {\bf Languages:} Python, JavaScript, PHP, \LaTeX, Java, Bash, Ruby, R, HTML, CSS, SQL
\item {\bf Frameworks:} Ruby on Rails, Node.JS, AngularJS
